...
class TestTask6 {
    /**
     * Expected non-membership price to avoid magic number error.
     */
    static final BigDecimal NON_MEMBERSHIP_PRICE = BigDecimal.valueOf(1374.87);
    /**
     * Expected membership price to avoid magic number error.
     */
    static final BigDecimal MEMBERSHIP_PRICE = BigDecimal.valueOf(1358.45);
    /**
    ...
    void nonMembershipTest() {
        assertEquals(NON_MEMBERSHIP_PRICE, myTestCart.calculateTotal());
    }
    /**
    ...
    void membershipTest() {
        ...
        assertEquals(MEMBERSHIP_PRICE, myTestCart.calculateTotal());
    }
